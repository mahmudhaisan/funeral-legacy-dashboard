...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['funeral_submit_button'])) {
    ...
    if (empty($existing_posts)) {
        ...
        if ($post_id) {
            ...
            echo '<div class="d-flex justify-content-between alert alert-success">';
            echo '<div class="" role="alert">Funeral post created successfully!</div>';
            echo '<p class="d-inline-block ml-2 mb-4"><a class="bg-primary text-white p-2 text-decoration-none" href="'.$funeral_list_url. '">View List</a></p>';
            echo '</div>';

        }
    } else {
        echo '<div class="container">';
        echo '<div class="d-flex justify-content-between alert alert-warning">';
        echo '<div class="" role="alert">You have already a funeral personality added. You can edit it here.</div>';
        echo '<p class="d-inline-block ml-2 mb-4"><a class="bg-primary text-white p-2 text-decoration-none" href="'.$funeral_list_url. '">View List</a></p>';
        echo '</div>';
    }
}
...
echo '<h3 class="mb-4">Add Legacy Dashboard</h3>';
